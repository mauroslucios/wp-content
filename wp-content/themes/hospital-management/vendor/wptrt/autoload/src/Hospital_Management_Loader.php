...
class Hospital_Management_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function hospital_management_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function hospital_management_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function hospital_management_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function hospital_management_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->hospital_management_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function hospital_management_load( $class ) {
