...
$audio = medical_care_get_media(array('audio','iframe'));

?>
<?php $medical_care_post_option = get_theme_mod( 'medical_care_grid_column','3_column');
    if($medical_care_post_option == '1_column'){ ?>
    <div class="col-lg-12 col-md-12">
<?php }else if($medical_care_post_option == '2_column'){ ?>
    <div class="col-lg-6 col-md-6">
<?php }else if($medical_care_post_option == '3_column'){ ?>
    <div class="col-lg-4 col-md-4">
<?php }else if($medical_care_post_option == '4_column'){ ?>
