...
$medical_care_ids = array();
foreach( $related as $term ) {
    $medical_care_ids[] = $term->term_id;
}

$medical_care_post_args['category__in'] = $medical_care_ids; 

$related_posts = new WP_Query( $medical_care_post_args );

if ( $related_posts->have_posts() ) : ?>
    <div id="Category-section" class="similar-post">
        <h3 class="text-center pb-3"><?php echo esc_html(get_theme_mod('medical_care_similar_text',__('Explore More','medical-care'))); ?></h3>
        <div class="row">
