...
class Medical_Care_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'medical-care' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $medical_care_font_awesome_icon_array = medical_care_font_awesome_icon_array();
                    foreach ($medical_care_font_awesome_icon_array as $medical_care_font_awesome_icon) {
                            $icon_class = $this->value() == $medical_care_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($medical_care_font_awesome_icon).'"></i>
                            <span class="medical-care-social-class">'.esc_attr($medical_care_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function medical_care_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'medical-care-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'medical_care_customizer_script' );

if(!function_exists('medical_care_font_awesome_icon_array')){
    function medical_care_font_awesome_icon_array(){
