...
function organic_farm_gettingstarted() {
	add_theme_page( esc_html__('Begin Installation', 'organic-farm'), esc_html__('Begin Installation', 'organic-farm'), 'edit_theme_options', 'organic-farm-guide-page', 'organic_farm_guide');
}
		...
		<div class="container">
			<div class="col-md-9">
				<div class="leftbox">
					...
					<p><?php esc_html_e('Go to dashboard >> Pages >> Add New Pages >> Add title, content and featured image >> Publish it.','organic-farm'); ?></p>
					<p><?php esc_html_e('Go to dashboard >> Appearance >> Customize >> Services Settings >> Select page','organic-farm'); ?></p>
					<a class="button-primary" href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=organic_farm_middle_section') ); ?>" target="_blank"><?php esc_html_e('Add Services Page','organic-farm'); ?></a>

					<p><?php esc_html_e('Go to dashboard >> Post >> Add New Post >> Add title, content and featured image >> Publish it.','organic-farm'); ?></p>
					<p><?php esc_html_e('Go to dashboard >> Appearance >> Customize >> Services Settings >> Select post','organic-farm'); ?></p>
					<p><?php esc_html_e('Go to dashboard >> Appearance >> Customize >> Services Settings >> Add Fontawesome icons classes ex: fas fa-envelope','organic-farm'); ?></p>
					...
					<h4><?php esc_html_e('4. Setup Courses','organic-farm'); ?></h4>
					<p><?php esc_html_e('Go to dashboard >> Post >> Add New Post Category >> Add New Post >> Add title, content, select post category and featured image >> Publish it.','organic-farm'); ?></p>
					<p><?php esc_html_e('Go to dashboard >> Appearance >> Customize >> Courses Settings >> Add section heading and select post category.','organic-farm'); ?></p>
					<a class="button-primary" href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=organic_farm_popular_courses') ); ?>" target="_blank"><?php esc_html_e('Add Courses','organic-farm'); ?></a>
				</div>
        	</div>
			<div class="col-md-3">
